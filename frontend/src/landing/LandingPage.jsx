...
const STATS = [
  { value: '10K+', label: 'Buildings Rendered' },
  { value: '60fps', label: 'Smooth Performance' },
  { value: '3D', label: 'WebGL / WebGPU' },
  { value: '∞', label: 'Developer Stories' },
]
    ...
    <div ref={containerRef} className={`landing ${visible ? 'landing--visible' : ''}`}>
      ...
      <section className="landing-hero">
        ...
        <div className="landing-hero__content">
          <div className="landing-hero__badge">Open Source Developer Visualization</div>
        ...
        <div className="landing-features__grid">
          {FEATURES.map((f, i) => (
            <div
              ...
              style={{ background: f.gradient, '--accent': f.accent }}
            >
      ...
      <section className="landing-cta">
        ...
        <h2>Ready to see your city?</h2>
        <p>Join thousands of developers who've already built their skyline.</p>
        <div className="landing-hero__actions">
      ...
      <footer className="landing-footer">
        <div className="landing-footer__inner">
          ...
          <div className="landing-footer__copy">
            Built with Three.js, React, and too much coffee.
          </div>
        </div>
      </footer>
    </div>
